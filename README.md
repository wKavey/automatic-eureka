...
1. We can roughly break down the project into separate stages:
2. Exploring CKAN to find which data are useful
3. Building parsers to actually inspect the contents of each data set in order to find additional indexable information
4. Building the tiered index
5. Designing the relevance measure (weighting certain fields, cosine, …)
